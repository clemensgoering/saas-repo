...
const HeroWhite = ( { config }: { config: HeroConfig } ) => {
            ...
            <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-40">
                <div className="mx-auto max-w-2xl lg:mx-0 lg:shrink-0 lg:pt-8">
                    <Image className="h-11" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600" width={200} height={300} alt="Your Company" />
                        ...
                        <h1 className="mt-10 text-5xl font-semibold tracking-tight text-pretty text-foreground sm:text-7xl">{ config.main_title }</h1>
                        <p className="mt-8 text-lg font-medium text-pretty text-foreground sm:text-xl/8">{ config.main_description }</p>
